...
class TestEnhancedSmartRetriever:
    ...
    def test_search_with_preference(self):
        ...
        results = self.retriever.search("What is the user's favorite food?", memories, limit=5)
    ...
    def test_search_with_time_filter(self):
        ...
        results = self.retriever.search("What did the user do 3 days ago?", memories, limit=5)
    ...
    def test_search_limit(self):
        ...
        memories = [
            {"content": f"Memory {i}", "timestamp": datetime.now().isoformat()} for i in range(20)
        ]
    ...
    def test_rank_by_importance(self):
        ...
        results = self.retriever.search("memory", memories, limit=5, rank_by_importance=True)
    ...
    def test_time_query_detection(self):
        ...
        memories = [
            {
                "content": "The user had a meeting yesterday",
                "timestamp": (datetime.now() - timedelta(days=1)).isoformat(),
            },
            {
                "content": "The user had a meeting 10 days ago",
    ...
    def test_combined_features(self):
        ...
        memories = [
            {
                "content": "The user recently mentioned favorite food is sushi",
                "timestamp": recent.isoformat(),
            },
            {
                "content": "The user mentioned old favorite food",
                "timestamp": (now - timedelta(days=20)).isoformat(),
            },
        ]

        results = self.retriever.search(
            "What did the user mention recently about favorite food?", memories, limit=5
        )
