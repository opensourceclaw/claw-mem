...
def test_scenario_1_e2e_operations():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        retriever = OptimizedRetriever(l1_size=1000, l2_size=5000, l2_ttl=300)
        ...
        ), f"❌ Cache hit rate {stats['hit_rate_percent']}% below 80%"
...
def test_scenario_5_recovery():
    ...
    ), f"❌ Success rate {stats['success_rate_percent']}% below 95%"
