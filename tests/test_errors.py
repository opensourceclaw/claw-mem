...
class TestFriendlyError:
    ...
    def test_error_with_suggestion(self):
        ...
        error = FriendlyError(message="Error message", suggestion="Try doing X")
    ...
    def test_error_with_error_code(self):
        ...
        error = FriendlyError(message="Error message", error_code="ERROR_001")
        assert "ERROR_001" in str(error)
        assert "[Error Code]" in str(error)

    def test_error_with_details(self):
        """Test error with details"""
        error = FriendlyError(message="Error message", details="Additional details here")
    ...
    def test_error_format_method(self):
        """Test format() method"""
        error = FriendlyError(
            message="Test", suggestion="Fix it", error_code="E001", details="Details"
        )
...
class TestErrors:
    ...
    def test_validation_error_kwargs(self):
        ...
        error = ValidationError(
            field="age", value="-5", reason="Must be positive", suggestion="Use positive numbers"
        )
    ...
    def test_configuration_error_detailed(self):
        ...
        error = ConfigurationError(
            config_key="max_results", current_value="-1", suggestion="Use positive number"
        )
    ...
    def test_configuration_error_kwargs(self):
        ...
        error = ConfigurationError(
            config_key="timeout", current_value="0", suggestion="Use timeout > 0"
        )
