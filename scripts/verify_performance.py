...
def test_performance():
    ...
    memories = [
        ...
        {
            "content": "claw-mem 仓库地址是 https://github.com/opensourceclaw/claw-mem",
            "tags": ["项目"],
    ...
    assert (
        stats["hit_rate_percent"] > 80
    ), f"❌ Hit rate {stats['hit_rate_percent']}% below 80% target"
    ...
    long_query = (
        "用户偏好使用中文交流,claw-mem 仓库地址是 https://github.com/opensourceclaw/claw-mem,Peter Cheng 是项目负责人"
        * 10
    )
