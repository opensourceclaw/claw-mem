...
def parse_properties_wcwidth(core, asian):
    ...
    return WcWidthResult(null=compress(null), wide=compress(wide))
...
def parse_properties_xid(core):
    ...
    return XidResult(id_start=compress(id_start), id_continue=compress(id_continue))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Extract xid and wcwidth information from Unicode standard"
    )
    parser.add_argument(
        "url",
        metavar="url",
