...

{
    ...
    "targets": [
                        ...
                        "configurations": {
                            "Release": {
                                "msvs_settings": {
                                    ...
                                    "VCLibrarianTool": {"AdditionalOptions": ["/LTCG:INCREMENTAL"]},
                                    "VCLinkerTool": {
        ...
        },
        {
            ...
            "variables": {
                "conditions": [
                    [
                        ...
                        {"pkg_config_path": "", "use_global_libvips": ""},
                    ]
                ]
            },
            "sources": [
            ...
            "conditions": [
                [
                    'use_global_libvips == "true"',
                    {
                        ...
                        "defines": ["SHARP_USE_GLOBAL_LIBVIPS"],
                        "conditions": [
                            [
                                'OS == "linux"',
                                {
                    ...
                    },
                    {
                        ...
                        "conditions": [
                            [
                                'OS == "win"',
                                {
                                    "defines": ["_ALLOW_KEYWORD_MACROS", "_FILE_OFFSET_BITS=64"],
                                    "link_settings": {"libraries": ["libvips.lib"]},
                                },
                            ],
                            [
                                'OS == "mac"',
                                {
                                    "link_settings": {
                                        "libraries": ["libvips-cpp.<(vips_version).dylib"]
                                    },
                                    "xcode_settings": {
                                        "OTHER_LDFLAGS": [
                                            "-Wl,-s",
                            ...
                            [
                                'OS == "linux"',
                                {
                                    ...
                                    "link_settings": {
                                        "libraries": ["-l:libvips-cpp.so.<(vips_version)"],
                                        "ldflags": [
                                            "-lstdc++fs",
                                            "-Wl,-s",
            ...
            "cflags_cc": ["-std=c++17", "-fexceptions", "-Wall", "-Os"],
            "xcode_settings": {
                "CLANG_CXX_LANGUAGE_STANDARD": "c++17",
                "MACOSX_DEPLOYMENT_TARGET": "10.15",
                "GCC_ENABLE_CPP_EXCEPTIONS": "YES",
                "GCC_ENABLE_CPP_RTTI": "YES",
                "OTHER_CPLUSPLUSFLAGS": ["-fexceptions", "-Wall", "-Oz"],
            },
            "configurations": {
                "Release": {
                    "conditions": [
                        ['target_arch == "arm"', {"cflags_cc": ["-Wno-psabi"]}],
                        [
                            'OS == "win"',
                            {
                                "msvs_settings": {
        ...
        },
        {
            ...
            "type": "none",
            "dependencies": ["sharp-<(platform_and_arch)"],
            "conditions": [
                [
                    'OS == "win"',
                    {
                        "copies": [
                            {
                                ...
                                "files": ["<(sharp_libvips_lib_dir)/libvips-42.dll"],
                            }
                        ]
                    },
                ]
