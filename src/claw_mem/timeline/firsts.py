...
class FirstEventsDetector:
    ...
    FIRST_PATTERNS = [
        ...
        (
            FirstEventType.FIRST_DAY_SCHOOL,
            [r"first day.*school", r"started school", r"first day at school"],
        ),
        (
            FirstEventType.FIRST_FRIEND,
            [r"first friend", r"made.*first friend", r"met.*first friend"],
        ),
        (FirstEventType.FIRST_LOVE, [r"first love", r"fell in love.*first", r"first relationship"]),
        (
            FirstEventType.FIRST_HEARTBREAK,
            [r"first heartbreak", r"heartbroken.*first", r"first breakup"],
        ),
        # Career firsts
        ...
        (
            FirstEventType.FIRST_PUBLICATION,
            [r"first publication", r"published.*first", r"first paper"],
        ),
        (FirstEventType.FIRST_AWARD, [r"first award", r"won.*first prize", r"first prize"]),
        # Experience firsts
        (
            FirstEventType.FIRST_TRIP,
            [r"first trip", r"traveled.*first time", r"first time traveling"],
        ),
        ...
        # Skill firsts
        (
            FirstEventType.FIRST_CODE,
            [r"first code", r"first program", r"coded.*first", r"programmed.*first"],
        ),
