...
class ChunkedIndex:
    ...
    def load_metadata(self) -> bool:
        ...
        try:
            ...
            print(
                f"✅ Metadata loaded in {elapsed:.2f}ms ({self.metadata.get('total_entries', 0)} entries)"
            )
    ...
    def search(
        self, query: str, chunk_ids: Optional[List[int]] = None, limit: int = 100
    ) -> List[Dict]:
        """
