...
DETECTION_RULES = {
    'decision': {
        'keywords': [
            "let's use", "let us use", "we'll use", "we will use",
            "we'll go with", "we will go with", "decide", "choose",
            "confirm", "agreed", "settled", "final",
            # Other language keywords
            "decided to", "decision is", "chose to",
            "going with", "picked", "selected",
            # ZH keywords
            "\u6211\u4eec\u9009\u62e9", "\u6211\u4eec\u51b3\u5b9a",
            "\u786e\u5b9a\u7528", "\u5c31\u9009", "\u5b9a\u4e86",
            "\u51b3\u5b9a", "\u9009\u62e9", "\u786e\u8ba4",
    ...
    'preference': {
        'keywords': [
            "prefer", "like", "want", "don't want",
            "my preference", "usually", "always", "never",
    ...
    'task_context': {
        'keywords': [
            "building", "working on", "creating", "developing",
            "task is", "project is", "goal",
            "next step", "current", "working on",
            # ZH keywords
            "\u5f00\u53d1", "\u6784\u5efa", "\u9879\u76ee",
            "\u4efb\u52a1", "\u76ee\u6807", "\u4e0b\u4e00\u6b65",
            "\u5728\u505a", "\u5728\u5f00\u53d1",
